<?php
    ...
    // 책정보를 배열로 저장
    // $BookArray = [
    //     "ISBN1234" => ["name" => "HTML5 웹프로그래밍","unitPrice" =>29000],
    ...
    // $BookArray["ISBN1234"]["description"] = "이 책은 웹 프로그래밍을 시작하는 입문자를 위한 실습서입니다.단계별 예제를 따라하며 HTML5, CSS3, 자바스크립트의 기초를 익히고 jQuery와 실무에서 쓰이는 다양한 플러그인을 경험할 수 있습니다.";
    ...
    // $BookArray["ISBN1235"]["description"] = "JSP의 이론적 개념 > 기본실습 > 응용실습 순의 단게별 학습이 가능합니다. 응용실습이 합쳐져 최종적으로 쇼핑몰 하나를 완성하는 구성이라 배운 내용이 어디에 어떻게 적용되는지 알 수 있습니다.";
